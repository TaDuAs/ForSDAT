smfsFilterTask = mgr.getTask('SMIFilterTask');
            ...
            results.statusData = {};
            results.exception = '';
            results.interactionWindow = [smfsFilterTask.filter.startAt smfsFilterTask.filter.endAt];
            results.noiseAnomaly = smfsFilterTask.filter.noiseAnomally;
            ...
            if ~isempty(specific.persistenceLength)
