classdef TailAnalysisView < mvvm.view.ComponentView
    methods
        function this = TailAnalysisView(parent, ownerView, varargin)
    ...
    methods (Access=protected)
        function initializeComponents(this)
            ...
            this.addChild(uicontrol('style', 'text', 'String', 'TailAnalysisView'));
        end
    end
end
